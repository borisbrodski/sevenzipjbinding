...
Current version: **`26.03-2.3`** (7‑Zip engine 26.03).
...
**Gradle**
```groovy
implementation 'net.sf.sevenzipjbinding:sevenzipjbinding:26.03-2.3'
implementation 'net.sf.sevenzipjbinding:sevenzipjbinding-all-platforms:26.03-2.3'
```
