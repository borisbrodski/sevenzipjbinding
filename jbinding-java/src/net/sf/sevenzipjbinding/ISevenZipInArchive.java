 ...
 * <br>
 * The interface provides functionity to query archive and archive item parameters, but also to extract of item content. <br>
 * <br>
 * The last call should be a call of the methode {@link ISevenZipInArchive#close()}. After this call no more Methods
 * should be called.
 * 
