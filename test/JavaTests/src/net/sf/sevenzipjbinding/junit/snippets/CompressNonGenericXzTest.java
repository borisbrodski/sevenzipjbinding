...
/**
 * Tests {@link CompressNonGenericXz} snippet.
 *
 * @author Boris Brodski
 * @since 9.20-2.00
 */
public class CompressNonGenericXzTest extends SnippetTest {
    private static final String SYSTEM_PROPERTY_TMP = "java.io.tmpdir";

    private String getExpectedOutput() {
        /* BEGIN_OUTPUT(CompressNonGenericXz) */
    ...
    public void testCompress() {
        ...
        File archiveFile = new File(tmpDir, "compressed.xz");

        beginSnippetTest();
        CompressNonGenericXz.main(new String[] { archiveFile.getAbsolutePath() });
