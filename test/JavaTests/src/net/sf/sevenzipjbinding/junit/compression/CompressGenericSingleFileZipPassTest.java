 ...
 * @since 9.20-2.00
 */
public class CompressGenericSingleFileZipPassTest extends CompressGenericSingleFileAbstractTest {

    public CompressGenericSingleFileZipPassTest(int size, int entropy) {
        super(size, entropy);
    }
