...
public abstract class CompressFeatureSetThreadCount extends CompressAbstractTest {
    ...
    public class CompressFeatureSetThreadCountUpdateCallback extends SingleFileArchiveUpdateCallback {
    ...
    private interface FeatureSetMultithreadingTester {
        public void applyFeatures(IFeatureSetMultithreading outArchive);
    }
    ...
    private long testCompressionFeatureSetThreadCount(FeatureSetMultithreadingTester tester) throws Exception {
        ...
        assertTrue(outArchive instanceof IFeatureSetMultithreading);
        IFeatureSetMultithreading featureOutArchive = (IFeatureSetMultithreading) outArchive;
        ...
        outArchive
                .updateItems(outputByteArrayStream, 1, new CompressFeatureSetThreadCountUpdateCallback(randomContext));
