...
public class StandaloneUpdateNonGenericXzTest extends JUnitNativeTestBase<VoidContext>{
    private static class UpdateItemContentArchiveUpdateCallback implements IOutCreateCallback<IOutItemXz> {
        ...
        public IOutItemXz getItemInformation(int index, OutItemFactory<IOutItemXz> outItemFactory)
            ...
            IOutItemXz outItem = outItemFactory.createOutItemAndCloneProperties(index);
    ...
    public void updateContent() throws Exception {
        ...
        IOutUpdateArchiveXz outArchiveConnected = inArchive.getConnectedOutArchiveXz();
    ...
    private ByteArrayStream compressVirtualContext(VirtualContent virtualContent) throws SevenZipException {
        ...
        IOutCreateArchive<IOutItemAllFormats> outArchive = closeLater(SevenZip.openOutArchive(ArchiveFormat.XZ));
