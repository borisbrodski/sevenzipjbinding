 ...
 */
static char * GetSevenZipErrorMessage(HRESULT hresult)
{
 ...
 */
void NativeMethodContext::ThrowSevenZipException(char * fmt, ...)
{
...
void NativeMethodContext::_VThrowSevenZipException(char * fmt, va_list args)
{
 ...
 * Throw SevenZipException with error message.
 */
void NativeMethodContext::ThrowSevenZipException(HRESULT hresult, char * fmt, ...)
{
...
void NativeMethodContext::_VThrowSevenZipException(HRESULT hresult, char * fmt, va_list args)
{
